                ...
                <div class="box">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ $service->title }}" placeholder="Enter title">
                        </div>

                        <div class="form-group">
                            <label for="except">Except</label>
                            <textarea class="form-control" id="except" name="except" placeholder="Enter except">{{ $service->except }}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="content">Content</label>
                            <textarea class="form-control" id="content" name="content" placeholder="Enter content">{!! $service->content !!}</textarea>
                        </div>
                        ...
                        <div id="faq-repeater">
                            ...
                            @foreach($service->faqs as $key => $value)
                                <div class="faq-group">
                                    <div class="form-group">
                                        <label>Question</label>
                                        <input type="text" class="form-control" name="faq-question[]" value="{{ $value->questions }}" placeholder="Enter question.">
                                    </div>
                                    <div class="form-group">
                                        <label>Answer</label>
                                        <textarea name="faq-answer[]" class="faq-answer form-control" placeholder="Enter answer">{{ $value->answer }}</textarea>
                                    </div>
